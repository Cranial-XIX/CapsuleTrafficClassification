...
axarr[0].plot(range(30), train_loss_cnn, label='cnn train loss')
axarr[0].plot(range(30), train_loss_capsule, label='capsule train loss')
axarr[0].set_title('Training loss and accuracy')
axarr[0].set_xlabel('Epoch')
axarr[0].set_ylabel('train loss')
axarr[0].legend()
axarr[1].plot(range(30), train_accuracy_cnn, label='cnn train accuracy')
axarr[1].plot(range(30), train_accuracy_capsule, label='capsule train accuracy')
